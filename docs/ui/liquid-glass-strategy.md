...
```css
.glass, .glass-strong, .glass-btn, .glass-pill {
  position: relative;
...
.glass::before {
  ...
  background: linear-gradient(180deg,
    var(--glass-edge-peak) 0%, var(--glass-edge-mid) 20%,
    transparent 40%, transparent 60%,
    var(--glass-edge-mid) 80%, var(--glass-edge-peak) 100%);
...
.composer-focus:focus-within {
  ...
  box-shadow: inset 0 1px 0 rgb(var(--glass-highlight)),
